...
public abstract class AbstractTeslaListActivity extends ListActivity {
	...
	protected IErrorHandler errorHandler = new IErrorHandler.Stub() {
		public void onServiceError(String title, String message, boolean fatal) throws RemoteException {
			showErrorMessage(AbstractTeslaListActivity.this.getClass(), title, message, null);
		}
	};
	...
	protected void onResume() {
		super.onResume();
		wakeLock.acquire();
		bindService(new Intent(AbstractTeslaListActivity.this, CommandService.class), connection, Context.BIND_AUTO_CREATE);
	}
	...
	public boolean onKeyDown(int keyCode, KeyEvent event) {
		...
		case KeyEvent.KEYCODE_HOME:
			...
			stopService(new Intent(AbstractTeslaListActivity.this, CommandService.class));
		}
	...
	protected void showErrorMessage(Class<? extends Object> invoker, String title, String message, Command command) {
		if (!isFinishing()) {
			...
			// Show error message
			new AlertDialog.Builder(AbstractTeslaListActivity.this)
				.setTitle(title)
				.setMessage(message)
